...
const services = [
  {
    icon: Smartphone,
    title: "Phone Repair",
    desc: "Complete diagnostics, system recovery, and structural hardware repairs for all major brands.",
  ...
  },
  {
    ...
    desc: "Cracked or bleeding displays replaced with OEM-grade OLED & LCD screens in under 30 minutes.",
  ...
  },
  {
    ...
    desc: "Fix crackling sounds, quiet speakers, broken microphones, and audio jack connectivity issues.",
